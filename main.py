...
bg_size = width, height = 480, 600  # 背景大小
screen = pygame.display.set_mode(bg_size)
pygame.display.set_caption("飞机大战 -- 龙一野 Demo")  # 窗口标题
...
# 载入游戏音乐
pygame.mixer.music.load("sound/game_music.ogg")  # 音频文件
pygame.mixer.music.set_volume(0.2)  # 音量调节
...
def main():
    ...
    pygame.time.set_timer(SUPPLY_TIME, 10 * 1000)  # 10秒
    ...
    while running:
        ...
        screen.blit(background, (0, 0))  # 背景显示
        if life_num and not paused:
            ...
            # 检测我方飞机是否被撞
            enemies_down = pygame.sprite.spritecollide(me, enemies, False, pygame.sprite.collide_mask)  # 机身区域检测
            if enemies_down and not me.invincible:
                me.active = False  # 改为True则无敌状态
